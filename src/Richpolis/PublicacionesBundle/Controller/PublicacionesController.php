...
class PublicacionesController extends FOSRestController
{
     ...
     * @Annotations\QueryParam(name="limit", requirements="\d+", default="5", description="How many publicaciones to return.")
     *
     * @Annotations\View(
     ...
     */
    public function getPublicacionAction($id)
    {
        if(is_numeric($id)){
    ...
    public function postPublicacionAction(Request $request)
    {
        try {
            ...
            $publicacion->setIsActive($parameters['isActive']);
